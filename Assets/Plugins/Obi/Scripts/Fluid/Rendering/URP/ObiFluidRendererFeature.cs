...
namespace Obi
{
    ...
    public class ObiFluidRendererFeature : ScriptableRendererFeature
    {
        ...
        public override void Create()
        {
            ...
            m_ThicknessPass = new ThicknessBufferPass();
            m_ThicknessPass.renderPassEvent = RenderPassEvent.AfterRenderingOpaques;

            m_SurfacePass = new SurfaceReconstruction();
            m_SurfacePass.renderPassEvent = RenderPassEvent.AfterRenderingOpaques;

            m_FoamPass = new FoamPass();
            m_FoamPass.renderPassEvent = RenderPassEvent.AfterRenderingOpaques;

            m_RenderFluidPass = new RenderFluidPass(RenderTargetHandle.CameraTarget);
            m_RenderFluidPass.renderPassEvent = RenderPassEvent.AfterRenderingOpaques;
